...
#define CFG_934X_DDR1_CONFIG_VAL	0x7fbc8cd0
...
#else
#define CFG_934X_DDR2_CONFIG_VAL	0x7fbc8cd0
...
#define CFG_934X_DDR2_TAP_VAL		5
#endif

#define CFG_934X_DDR1_TAP_VAL		0xf
...
#define is_ar9330()     (((ar7240_reg_rd(AR7240_REV_ID) & HORNET_REV_ID_MASK) == HORNET_REV_1_0) || \
                         ((ar7240_reg_rd(AR7240_REV_ID) & HORNET_REV_ID_MASK) == HORNET_REV_1_1) )
#else
#define is_ar9330()     0
#endif
