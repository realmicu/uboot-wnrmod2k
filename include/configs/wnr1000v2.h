 ...
 * specific for Netgear WNR1000v2 router.
 */

#ifndef __WNR1000V2_H
#define __WNR1000V2_H
 ...
 *****************
 */
#define CFG_AR7241_PLL_FREQ	CFG_PLL_340_340_170
 ...
 * It's HW_ID would be "29763331+04+32".
 * "(8 MSB of PCB number)+(Flash size)+(SDRam size)", length should be 14
 */
#if (FLASH_SIZE == 16)
#	define BOARD_HW_ID_DEFAULT		"29763331+16+32"
#elif (FLASH_SIZE == 8)
#	define BOARD_HW_ID_DEFAULT		"29763331+08+32"
#else /* FLASH_SIZE == 4 */
#	define BOARD_HW_ID_DEFAULT		"29763331+04+32"
#endif
 ...
 **************
 */
#define CFG_PROMPT	"wnr1000v2> "      /* Monitor Command Prompt    */
