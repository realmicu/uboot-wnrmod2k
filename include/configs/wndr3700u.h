 ...
 * specific for Netgear WNDR3700(u/v1) router.
 */

#ifndef __WNDR3700U_H
#define __WNDR3700U_H
...
/*
 * wndr3700 hardware's PCB number is 2976326605, 8M Flash, 64M SDRam
...
#elif (FLASH_SIZE == 8)
#	define BOARD_HW_ID_DEFAULT		"29763266+08+64"
#else /* FLASH_SIZE == 4 */
 ...
 **************
 */
#define CFG_PROMPT	"wndr3700v1> "      /* Monitor Command Prompt    */
