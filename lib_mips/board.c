...
#ifdef CFG_NMRP
extern void StartNmrpClient(void);
#endif /* CFG_NMRP */
...
#if defined(CONFIG_WNR2000V3)
extern uint32_t get_magic_number_of_wnr2000v3(void);
#elif defined(CONFIG_WNR2200)
extern uint32_t get_magic_number_of_wnr2200(void);
...
extern uint32_t	GetMagicNumberOfWnr1000v2(void);
extern void wnr1000v2_power_led(int);
extern void wnr1000v2_test_led(int);
extern void wnr1000v2_reset_default_LedSet(void);
extern int wnr1000v2_reset_button_is_press(void);
extern void wnr1000v2_reset_default(void);
#endif /* defined(CONFIG_WNR2000V3) */
