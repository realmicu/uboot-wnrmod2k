...
// Added by wayne on 12/18/2009 for disabling JATA input
#define AR9285_GPIO_IN_ENABLE                      0x4054 // GPIO input enable
#define AR9285_GPIO_IN_JTAG_BIT			 17	// 0: enable, 1: disable
...
// Added by wayne on 12/29/2009
void ar9285DisableJTAG(unsigned int uDisable)
{
	ar9285_reg_rmw(AR9285_GPIO_IN_ENABLE,  (uDisable ? 1: 0) << AR9285_GPIO_IN_JTAG_BIT, \
					AR9285_GPIO_BIT(AR9285_GPIO_IN_JTAG_BIT));
}
